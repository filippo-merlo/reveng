...
import reveng
from reveng.environment_generator.env_transformations import ReflectEnv, RotateEnv, TransposeEnv, StartGoalSwap
import matplotlib.pyplot as plt

dataset_path = 'C:/users/hchen/dropbox/reveng/src/reveng/experiments/datasets/baseline_grids.pkl'
